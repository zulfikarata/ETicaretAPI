...
namespace ETicaretAPI.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(IProductService productService, IProductReadRepository productReadRepository, IProductWriteRepository productWriteRepository, IMediator mediator)
        {
        ...
        {
            CreateProductCommandResponse request = await _mediator.Send(createProductCommandRequest);
