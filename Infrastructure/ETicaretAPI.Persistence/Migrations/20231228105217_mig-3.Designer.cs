...
namespace ETicaretAPI.Persistence.Migrations
{
    ...
    [Migration("20231228105217_mig-3")]
    partial class mig3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileImageFile", b =>
                {
                    ...
                    b.HasKey("FilesId", "ImageFilesId");

                    b.HasIndex("ImageFilesId");

                    b.ToTable("FileImageFile");
                });
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.ImageFile", b =>
                {
            ...
            modelBuilder.Entity("FileImageFile", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.File", null)
                        .WithMany()
                        .HasForeignKey("FilesId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("ETicaretAPI.Domain.Entities.ImageFile", null)
                        .WithMany()
